...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppJsx = __webpack_require__(168);

	var _AppJsx2 = _interopRequireDefault(_AppJsx);

	ReactDom.render(_react2['default'].createElement(_AppJsx2['default'], null), document.getElementById('root'));
	  ...
	  _createClass(ChannelSection, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        '/>',
	        _react2['default'].createElement(_ChannelFormJsx2['default'], null),
	        '>'
	      );
	    }
	  }]);
